...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="col col-md-2 form-group">
              <label class="font-weight-bold" for="text1">Tex :</label>
              <input id="tex" type="text" class="form-control" name="tex" placeholder="tex" >
            </div>
    <div class="col col-md-2 form-group">
              <label class="font-weight-bold" for="text1">Tex1 :</label>
              <input id="tex1" type="text" class="form-control" name="tex1" placeholder="tex1" >
            </div>
    <div class="col col-md-2 form-group">
